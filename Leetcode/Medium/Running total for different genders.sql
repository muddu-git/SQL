...
day,
sum(score_points) 
over (partition by gender order by day rows between unbounded preceding and current row) total
from scores;

-- it will work without 'rows between' as default is 'unbounded preceding and current row'
